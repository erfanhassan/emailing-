...
echo "=== Starting AI Outreach Dashboard ==="
...
# Start Streamlit on port 8501 (or $PORT for Cloud Run compatibility)
echo "[2/2] Starting Streamlit on port ${PORT:-8501}..."
...
echo "  Streamlit PID:         $STREAMLIT_PID (port ${PORT:-8501})"
